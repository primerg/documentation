...
This method uses a [Custom Upstream](/docs/custom-upstream), a feature available to EDUs, Enterprises, and [Pantheon Partner Agencies](https://pantheon.io/agencies/partner-program){.external}.
